                ...
                <form method="POST" action="/daftar" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                            name="name" value="{{ old('name') }}" placeholder="Silahkan masukkan nama anda">
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                            name="email" value="{{ old('email') }}" placeholder="Silahkan masukkan email anda">
                        @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('nomor_wa') is-invalid @enderror" id="nomor_wa"
                            name="nomor_wa" value="{{ old('nomor_wa') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('asal_sekolah') is-invalid @enderror"
                            ...
                            placeholder="Silahkan masukkan asal sekolah anda">
                        @error('asal_sekolah')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('bukti_tf') is-invalid @enderror" type="file" id="bukti_tf"
                            name="bukti_tf">
                        @error('bukti_tf')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <button type="submit" class="btn btn-primary"
                        onclick="return confirm('Yakin daftar? Pastikan semua data yang diinput sudah sesuai')">Daftar</button>
                </form>
            </div>
        </div>
    </div>
